...
def generate_random_article(outlet: Optional[NewsOutlet] = None):
    ...
    news = News(
        ...
        affected_stocks = [target_stock.symbol],
        affected_categories = [target_stock.category],
        timestamp = time.time(),
    )
